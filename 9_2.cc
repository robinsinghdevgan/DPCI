...
int uniqueRoutesFrom0_0_ToX_Y_DP(const int x, const int y)
{
    ...
    for (int j = 1; j <= y; ++j)
    {
        for (int i = 1; i <= x; ++i)
        {
            ...
            arr[i][j] = total_ways_from_west + total_ways_from_south;
            // -------*
            //        |
            //        |
...
int main(int argc, char const *argv[])
{
    ...
    assert(uniqueRoutesFrom0_0_ToX_Y_DP(1, 1) == 2);
    assert(uniqueRoutesFrom0_0_ToX_Y_DP(1, 2) == 2);
    assert(uniqueRoutesFrom0_0_ToX_Y_DP(1, 3) == 3);
    assert(uniqueRoutesFrom0_0_ToX_Y_DP(1, 4) == 4);
    assert(uniqueRoutesFrom0_0_ToX_Y_DP(2, 1) == 1);
    assert(uniqueRoutesFrom0_0_ToX_Y_DP(2, 2) == 3);
    assert(uniqueRoutesFrom0_0_ToX_Y_DP(2, 3) == 3);
    assert(uniqueRoutesFrom0_0_ToX_Y_DP(2, 4) == 7);
    assert(uniqueRoutesFrom0_0_ToX_Y_DP(3, 1) == 2);
    assert(uniqueRoutesFrom0_0_ToX_Y_DP(3, 2) == 5);
    assert(uniqueRoutesFrom0_0_ToX_Y_DP(3, 3) == 8);
    assert(uniqueRoutesFrom0_0_ToX_Y_DP(3, 4) == 8);
